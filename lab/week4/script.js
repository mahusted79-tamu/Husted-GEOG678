...
function findTopRight(pointList) {
    ...
    return {"pointId": 1, "lat": maxLat, "lon": maxLon}
};
...
function findBottomLeft(pointList) {
    ...
    return {"pointId": 1, "lat": minLat, "lon": minLon}
};
...
function findBottomRight(pointList) {
    ...
    return {"pointId": 1, "lat": minLat, "lon": maxLon}
};
...
function Run() {
    ...
    console.log("Bounding box computed for mahusted79@tamu.edu: ");
